...
from memmachine.server.prompt.financial_analyst_prompt import FinancialAnalystSemanticCategory
from memmachine.server.prompt.health_assistant_prompt import HealthAssistantSemanticCategory
from memmachine.server.prompt.profile_prompt import UserProfileSemanticCategory
from memmachine.server.prompt.writing_assistant_prompt import WritingAssistantSemanticCategory
